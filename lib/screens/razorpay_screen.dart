...
class _RazorpayScreenState extends State<RazorpayScreen> {
  ...
  onPaymentSuccess(payment_details) async{
    ...
    var razorpayPaymentSuccessResponse = await PaymentRepository().getRazorpayPaymentSuccessResponseResponse(widget.payment_type, widget.amount,_order_id, payment_details);
